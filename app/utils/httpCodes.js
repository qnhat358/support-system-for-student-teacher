...
const httpErrorTransform = {
  'bad_request': 'Invalid request was provided.',
  'unauthenticated': 'The request is unauthenticated.',
  'token_invalid': 'Token is not valid.',
  'unauthorized': 'The account is unauthorized.',
  'forbiden': 'The account is unauthorized.',
  'not_found': 'The resource is not found.',
  'method_not_allowed': 'This method type is not supported.',
  'request_timeout': 'The request is timed out.',
  'internal_server_error': 'A system error has occurred. Please contact your system administrator.',
  'query_error': 'Error executing query',
  'third_party_api_error': 'Request to third party api get errors.',
  'system_error': 'A system error has occurred. Please contact your system administrator.',
}
module.exports = {httpCodes, httpErrorTransform};